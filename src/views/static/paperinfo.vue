<template>
    <div class="head">
        ...
        <el-table :data="papers" style="width: 100%">
            ...
            <el-table-column prop="createTime" label="用户编号" width="120" />
            <el-table-column prop="updateTime" label="论文题目" width="120" />
            <el-table-column prop="roleIds" label="论文类型" width="120" />
            <el-table-column prop="userId" label="刊物" width="120" />
    ...
    methods: {
        ...
        get() {
            ...
            getPaper(userId).then(res => {
                if (res.success) {
                    this.papers = res.data.userRoles.slice(start, end);//去浏览器的控制台看名字 我发的视频里也有
                    this.pageinfo.totalpage = res.data.userRoles.length;
