<template>
  <el-menu class="el-menu-demo" mode="horizontal" background-color="#545c64" text-color="#fff"
    active-text-color="#ffd04b" router default-active="1">
    <el-menu-item index="1" class="item1" v-if="admin">管理中心</el-menu-item>
    <el-menu-item index="1" class="item1" v-else>权限管理</el-menu-item>
    <el-menu-item index="/user/info" >个人信息中心</el-menu-item>
    <el-menu-item  v-if="admin" @click="exitroot">退出管理</el-menu-item>
    <el-menu-item  v-else @click="DialogVisible=true">获取管理权限</el-menu-item>
  </el-menu>
...
methods:{
  ...
  exitroot(){
    localStorage.removeItem('admin')
    this.admin=false;
    this.$router.push('/admin/rolecontroller')
  }
}
